...
namespace nhom8
{
    public partial class frmSuaKH : Form
    {
        ...
        public frmSuaKH(string maKH, string ten, string diaChi, string sdt)
        {
            InitializeComponent();
            this.maKH = maKH; // Gán mã NPP vào biến toàn cục
            tbMaKH.Text = maKH;
            tbTen.Text = ten;
            tbDC.Text = diaChi;
            tbSDT.Text = sdt;
        ...
        private void btSuaKH_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@makh", maKH); // Mã NPP không thay đổi
